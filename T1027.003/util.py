...
# def embed_data_into_image(image_path, data_path, output_path):
#     """Встраивание данных из файла в изображение методом LSB."""
...
#     binary_data = ''.join([int_to_bin(byte) for byte in data])
...
#     # Встраиваем данные
#     embed_data_into_image("турист.png", "test.exe", "stego_image.png")

#     # Извлекаем данные
#     extract_data_from_image("stego_image.png", "extracted_file.exe")
...
if __name__ == "__main__":
    # Встраиваем данные
    embed_data_into_image("турист.png", "test.exe", "stego_image.png", "äô¹QÜ&s|ùWÎ~Ú¹_äb£7UÜ£#V¥wSQ}µG¥7SQW¸´ôsqAGmª¦Ø2³9m(ØáGb3wíYUWGÜ3wUY¾Êw")

    # Извлекаем данные
    extract_data_from_image("stego_image.png", "extracted_file.exe", "äô¹QÜ&s|ùWÎ~Ú¹_äb£7UÜ£#V¥wSQ}µG¥7SQW¸´ôsqAGmª¦Ø2³9m(ØáGb3wíYUWGÜ3wUY¾Êw")
